...
from app.routers.expenses.read_one import read_expense_router
from app.routers.expenses.total import total_expenses_router
from app.routers.expenses.update import update_expense_router
...
expenses_router.include_router(update_expense_router)
expenses_router.include_router(delete_expenses_router)
expenses_router.include_router(total_expenses_router)
